...
public class MonthView extends ViewGroup {
    ...
    private static final int COLOR_RESET = 0;//重置文字颜色  无颜色
    private static final int COLOR_SET = 1;//设置文字颜色  有颜色
    private static final int COLOR_TODAY = 2;//当天的颜色
    ...
    private boolean disableBefore;  //之前的时间无法点击
            ...
            if (date.getType() == 1) {
                ...
                if ((date.getSolar()[0] < dateInit[0]
                    ...
                    if (disableBefore) {
                        ...
                        view.setTag(-1);
                        addView(view, i);
                        continue;           //不往下面走以为这点击事件的监听没有加意味着点击无效
                    }
                }
            }
                ...
                public void onClick(View v) {
                    ...
                    if (date.getType() == 1) {   //点击当月
                        if (chooseListener != null) {   //多选的情况
                            ...
                            if (lastClickedView != null  ) {  //不是当天的 如果是当天颜色在换一种
